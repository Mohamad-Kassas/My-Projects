...
def predict():
    if count_rock > count_paper and count_rock > count_scissors:
        pred = 0
    elif count_paper > count_scissors and count_paper > count_rock:
        pred = 1
...
valid_entries = ['0', '1', '2']
score = int(input("Enter the number of rounds you want to play: "))
while True:
    user_input = input("Enter 0 for ROCK, 1 for PAPER and 2 for SCISSORS: ")

    while user_input not in valid_entries:
        print("Invalid Input!")
        user_input = input("Enter 0 for ROCK, 1 for PAPERand 2 for SCISSORS: ")
